...
describe('dateTime.util testSuite', () => {
    ...
    it ("today() should return today's date", () => {
        assert.deepEqual(dateTimeUtil.today(), new Date(), 'dateTimeUtil.today() returns incorrect date');
    });
    ...
    it ('setYear(year) should return date with changed year', () => {
        ...
        assert.deepEqual(dateTimeUtil.setYear(initialDate, yearToSet), expectedDate, 'dateTimeUtil.setYear() returns incorrect date');
    });
    ...
    it ('dateDifference(dateLeft, dateRight) should return timestamp difference', () => {
        ...
        const expectedDifference = dayToSet - initialDay;
